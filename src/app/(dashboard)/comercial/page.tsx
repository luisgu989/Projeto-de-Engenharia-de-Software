...
import { Users, TrendingUp, GitMerge, ShoppingCart } from "lucide-react";
...
export default function ComercialPage() {
  ...
  const submodules = useMemo(() => {
    return [
      ...
      { title: "Oportunidades", href: "/oportunidades", icon: TrendingUp },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-border pb-4">
        <h2 className="text-xl md:text-2xl font-bold tracking-tight text-foreground">Comercial & CRM</h2>
        <p className="text-sm text-muted-foreground mt-1">
          Gerencie o relacionamento com clientes, pipeline de vendas, oportunidades e lançamentos comerciais.
        </p>
      </div>
